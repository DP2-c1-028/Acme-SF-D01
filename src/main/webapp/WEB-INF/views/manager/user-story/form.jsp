...
<acme:form>
	<acme:input-textbox code="manager.user-story.form.label.title"
		path="title" />
	<acme:input-textbox code="manager.user-story.form.label.description"
		path="description" />
	...
	<jstl:choose>
		...
		<jstl:when test="${_command == 'create' && projectId!=null}">
