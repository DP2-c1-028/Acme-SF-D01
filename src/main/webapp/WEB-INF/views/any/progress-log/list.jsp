...
<acme:list>
	...
	<acme:list-column code="any.progress-log.list.label.completeness" path="completeness" width="10%" />
	<acme:list-column code="any.progress-log.list.label.comment" path="comment" />
